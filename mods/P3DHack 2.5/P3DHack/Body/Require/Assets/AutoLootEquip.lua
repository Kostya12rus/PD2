...
firestarterd2 = firestarterd2 or function(count)
	for _, script in pairs(managers.mission:scripts()) do
		for editor_name, element in pairs(script:elements()) do
			if element:editor_name() == 'coke' or element:editor_name() == 'gold'
			or element:editor_name() == 'cash' or element:editor_name() == 'wep' then
				element:on_executed()
			end
		end    
	end
...
nightclub = nightclub or function(id)
	...
	local rand137 = id_ncrandomloot2[math.random(#id_ncrandomloot3)]
...
function autoloot()
	if inGame() and isPlaying() and isHost() then
		...
		elseif managers.job:current_level_id() == "arm_cro" then transportcross()
			...
			ChatMessage("На этой карте недоступно", "Автолут")
			return
		end
	elseif not isHost() then
			ChatMessage("Вы не хост", "Автолут")
		return
	end
	ChatMessage("Случайный лут заспавнен", "Автолут")
end
-----------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------
------- AUTO MATERIAL SPAWNER v1.0 ----------
------- By: SirGoodsmoke --------------------
---------------------------------------------
--------------------------
---- SPAWN FUNCTIONS -----
--------------------------
branchbanke = branchbanke or function()
    local id_brandomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        false
    }
    local id_brandomequippos = {
        Vector3(-781, 1767, 60.5),
        Vector3(-2457, 730, 100)
    }
    
    local rand = id_brandomequip[math.random(#id_brandomequip)]
    local randpos = id_brandomequippos[math.random(#id_brandomequippos)]
    
    local spawns = {
        rand and World:spawn_unit( rand,
        randpos, Rotation(180) )    
    }
    for k,v in pairs(spawns) do if v then v:interaction():set_active(true,true) end end
	end

diamondstoree = diamondstoree or function()
    local id_dsrandomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        false,
    ...
    local rand = id_dsrandomequip[math.random(#id_dsrandomequip)]

    local spawns = {
        rand and World:spawn_unit( rand,
        Vector3(1673, 692, 86), Rotation(90) )    
    }
    for k,v in pairs(spawns) do if v then v:interaction():set_active(true,true) end end
	end

gobanke = gobanke or function()
    local id_gbrandomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
    ...
    local id_gbrandomequippos = {
        Vector3(-405, -1550, 32),
        Vector3(-876, 1696, 44)
    }
    
    local rand = id_gbrandomequip[math.random(#id_gbrandomequip)]
    local randpos = id_gbrandomequippos[math.random(#id_gbrandomequippos)]
...
shadowraide = shadowraide or function()
    local id_srrandomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        false
    }
    local id_srrandomequippos = {
        Vector3(327, -3461, 1052),
        Vector3(-537, -4905, 1054),
        Vector3(-3509, -5021, 1449)
    }
    
    local rand = id_srrandomequip[math.random(#id_srrandomequip)]
    local randpos = id_srrandomequippos[math.random(#id_srrandomequippos)]
...
nightclube = nightclube or function()
    local id_ncrandomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        false
    }
    local id_ncrandomequippos = {
        Vector3(372, -5199, 26),
        Vector3(2063, -6671, 94),
        Vector3(1881, -7270, 74),
        Vector3(2345, -7359, 85)
    }
    
    local rand = id_ncrandomequip[math.random(#id_ncrandomequip)]
    local randpos = id_ncrandomequippos[math.random(#id_ncrandomequippos)]
...
bigoilday2e = bigoilday2e or function()
    local id_borandomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        false
    }
    local id_borandomequippos = {
        Vector3(-1068, 180, 100),
        Vector3(513, 77, 75),
        Vector3(-338, -2014, 101),
        Vector3(-2339, -1529, 101),
        Vector3(-1801, -466, 101)
    }
    
    local rand = id_borandomequip[math.random(#id_borandomequip)]
    local randpos = id_borandomequippos[math.random(#id_borandomequippos)]
...
electionday1e = electionday1e or function()
    local id_edd1randomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        false
    }
    local id_edd1randomequippos = {
        Vector3(6084, -32, 99),
        Vector3(4992, 3166, 99),
        Vector3(2074, 2457, 75),
        Vector3(4987, 1308, 0)
    }
    
    local rand = id_edd1randomequip[math.random(#id_edd1randomequip)]
    local randpos = id_edd1randomequippos[math.random(#id_edd1randomequippos)]
...
electiondaywhe = electiondaywhe or function()
    local id_edwhrandomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        false
    }
    local id_edwhrandomequippos = {
        Vector3(-469, -726, 87),
        Vector3(1653, -1318, 101),
        Vector3(-2318, -1151, 173)
    }
    
    local rand = id_edwhrandomequip[math.random(#id_edwhrandomequip)]
    local randpos = id_edwhrandomequippos[math.random(#id_edwhrandomequippos)]
    ...
    local spawns = {
        ...
        World:spawn_unit( Idstring(
        "units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Vector3(-617, 3401, 75), Rotation(90) )    
    }
    for k,v in pairs(spawns) do if v then v:interaction():set_active(true,true) end end
	end

framingframed3 = framingframed3 or function()
    local id_ffd3randomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        false
    }
    local id_ffd3randomequippos = {
        Vector3(-2323, 5978, 4227),
        Vector3(-4697, 5712, 3470),
        Vector3(-3318, 2676, 3100)
    }
    
    local rand = id_ffd3randomequip[math.random(#id_ffd3randomequip)]
    local randpos = id_ffd3randomequippos[math.random(#id_ffd3randomequippos)]
...
bigbanke = bigbanke or function()
    local id_bbrandomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        false
    }
    local id_bbrandomequippos = {
        Vector3(2030, 875, -905),
        Vector3(632, -1558, -909),
        Vector3(731, -1873, -524),
        Vector3(1322, -1888, -524),
        Vector3(2986, 1229, -524)        
    }
    
    local rand = id_bbrandomequip[math.random(#id_bbrandomequip)]
    local randpos = id_bbrandomequippos[math.random(#id_bbrandomequippos)]
...
firestarterd2e = firestarterd2e or function()
    local id_bbrandomequip = {
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
        Idstring("units/payday2/pickups/gen_pku_keycard/gen_pku_keycard"),
    ...
    local id_bbrandomequippos = {
        Vector3(1043, -1398, 74),
        Vector3(-1897, -2563, 475),
        Vector3(464, 609, 475)        
    }
    ...
    local spawns = {
        rand and World:spawn_unit( rand,
        Vector3(464, 609, 475), Rotation(90) ),            
    }
    for k,v in pairs(spawns) do if v then v:interaction():set_active(true,true) end end
end
...
function autoequip()
    if inGame() and isPlaying() and isHost() then
        ...
        if managers.job:current_level_id() == "branchbank" then branchbanke()

        elseif managers.job:current_level_id() == "family" then diamondstoree()

        elseif managers.job:current_level_id() == "roberts" then gobanke()

        elseif managers.job:current_level_id() == "election_day_1" then electionday1e()    

        elseif managers.job:current_level_id() == "election_day_2" then electiondaywhe()

        elseif managers.job:current_level_id() == "firestarter_3" then branchbanke()

        elseif managers.job:current_level_id() == "firestarter_2" then firestarterd2e()

        elseif managers.job:current_level_id() == "welcome_to_the_jungle_2" then bigoilday2e()

        elseif managers.job:current_level_id() == "nightclub" then nightclube()

        elseif managers.job:current_level_id() == "kosugi" then shadowraide()
        
        elseif managers.job:current_level_id() == "framing_frame_3" then framingframed3()
    
		else
			ChatMessage("Спец. оборудование заспавнено", "Авто экипировка")
			return
		end
    elseif not isHost() then 
        ChatMessage("Вы не хост", "Авто экипировка")
		return
    end
    ChatMessage("Спец. оборудование заспавнено", "Авто экипировка")
end