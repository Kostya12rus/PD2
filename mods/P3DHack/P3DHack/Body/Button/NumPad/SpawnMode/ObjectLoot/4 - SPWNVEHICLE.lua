...
spwnvehicler2 = spwnvehicler2 or function()
	...
	World:spawn_unit(Idstring("units/payday2/vehicles/str_vehicle_car_ford_graffiti/str_vehicle_car_ford_graffiti"), pos, randvrot)
end
...
spwnvehicleff1 = spwnvehicleff1 or function()
	...
	World:spawn_unit(Idstring("units/payday2/vehicles/sub_vehicle_train_seata_dmg/sub_vehicle_train_seata_dmg"), pos, randvrot)
end
...
spwnvehiclebb = spwnvehiclebb or function()
	...
	World:spawn_unit(Idstring("units/payday2/vehicles/str_vehicle_van_player/str_vehicle_van_player"), pos, randvrot)
end
----------------------
-------GAME-----------
----------------------
if inGame() and isPlaying() and isHost() and not inChat() then
	...
	elseif managers.job:current_level_id() == "big" then
		...
		showHint("Спавн случайного лута [Недоступен здесь]",3)
	end
else
